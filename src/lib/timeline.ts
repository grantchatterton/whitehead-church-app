...
export async function getTimelineEvents(): Promise<TimelineEvent[]> {
  return [
    ...
    },
    {
      ...
      date: "Present Day",
      description:
        "Today, Whitehead Baptist Church continues to be a place of worship, welcome, and spiritual renewal. We give all honor and praise to God for His provision, His faithfulness, and for allowing us to gather in this sacred place to worship Him together.",
    },
  ];
}
